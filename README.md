...
## Data
A CSV that contains a cleaned dataset of previous SOTU speeches can be found in the material folder, along with some articles providing more context on the importance of the case study and why the tone of the speech matters. 
